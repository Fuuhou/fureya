...
if [ "$(systemd-detect-virt)" == "openvz" ]; then
  ...
  sleep 1
  echo -e "Support OS Debian 10 & Ubuntu 18/20 LTS"
  sleep 1
  read "Press [ Enter ] to continue installation"
  sleep 1
  clear
function LOGO() {
echo -e "
...
gotop_latest="$(curl -s https://api.github.com/repos/xxxserxxx/gotop/releases | grep tag_name | sed -E 's/.*"v(.*)".*/\1/' | head -n 1)"
    ...
    chronyc tracking -v
gihub=
    wget -q https://raw.githubusercontent.com/Fuuhou/fureya/main/bbr.sh &&  chmod +x bbr.sh && ./bbr.sh

function pasang_domain() {
clear
LOGO
echo -e " ━━━━━━━━━━━━━━━━━━━━"
echo -e "   \e[1;32m SETUP DOMAIN           "
echo -e " ━━━━━━━━━━━━━━━━━━━━"
echo -e "   \e[1;32m1)\e[0m Your Domain"
echo -e "   \e[1;32m2)\e[0m Random Domain"
echo -e " ━━━━━━━━━━━━━━━━━━━━"
read -p " Choose Options [ 1 - 2 ] : " host
echo ""
if [[ $host == "1" ]]; then
...
#install ssh ovpn
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "$red          Install SSH                $NC"
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
sleep 2
clear
wget https://raw.githubusercontent.com/Fuuhou/fureya/main/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
# install backup
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "$red          Install Backup             $NC"
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
sleep 2
wget https://raw.githubusercontent.com/Fuuhou/fureya/main/set-br && chmod +x set-br.sh && ./set-br.sh
clear
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
sleep 2
clear
wget https://raw.githubusercontent.com/Fuuhou/fureya/main/insxray.sh && chmod +x insxray.sh && ./insxray.sh
clear
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "$red          Install Websocket             $NC"
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
sleep 2
wget -O /usr/local/bin/ws-dropbear https://raw.githubusercontent.com/Fuuhou/fureya/main/dropbear-ws.py
wget -O /usr/local/bin/ws-stunnel https://raw.githubusercontent.com/Fuuhou/fureya/main/ws-stunnel
chmod +x /usr/local/bin/ws-dropbear
chmod +x /usr/local/bin/ws-stunnel

wget https://raw.githubusercontent.com/Fuuhou/fureya/main/free.zip
unzip free.zip
chmod +x menu/*
...
echo -ne "Do you want to reboot now? (y/n)? "
read answer
