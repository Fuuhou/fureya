...
sleep 1
echo -e "Setting ntp date..."
ntpdate pool.ntp.org 
timedatectl set-ntp true
sleep 1
echo -e "Enable chronyd..."
systemctl enable chronyd
systemctl restart chronyd
sleep 1
echo -e "Enable chrony..."
systemctl enable chrony
systemctl restart chrony
timedatectl set-timezone Asia/Jakarta
sleep 1
echo -e "Setting chrony tracking..."
chronyc sourcestats -v
chronyc tracking -v
echo -e "Setting others..."
...
[Unit]
Description=https://t.me/xiestorez
...
KEY="6667234453:AAHdV1cDcQqDHW2tKAM88CgOX0ygAtEr4lk"
...
━━━━━━━━━━━━━━━━━━
"
curl -s --max-time 10 -d "chat_id=$CHATID&disable_web_page_preview=1&text=$txz&parse_mode=html" $link >/dev/null
